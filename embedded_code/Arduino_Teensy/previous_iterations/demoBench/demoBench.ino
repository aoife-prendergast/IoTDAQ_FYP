...
#define NUM_SAMPLES 100                            // set how many samples you want to poll from the sensors
...
//Bounce pushbutton = Bounce(hallEffectPin, 10);  // 10 ms debounce
...
byte XpreviousState = HIGH;         // what state was the button last time
unsigned int XcountAt = 0;         // when count changed
unsigned int Xcount = 0;            // how many times has it changed to low
unsigned int XcountPrinted = 0;     // last count printed
