/*
  ...
  Trial run for telemetry testing 
  Includes 
  - GPS 
  - Signal information 
  - Telemetry 
  ...
  Note:
  - Without DAQ 2020 sensors - sends dummy data
...
void loop() { // run over and over
  ...
  if ( everySecond >= 1000 ) {
    ...
    liveMQTTData =  gps_info + "#" + connection + "#" + daq2020data + "#" + accelerometerData + "# "+ signalQuality + "#" + ueInfo ;
...
String send_message(String message) {
  ...
  Serial.print("MQTT: Attempting to send message: ");
