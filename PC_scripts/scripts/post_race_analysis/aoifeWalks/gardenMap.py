...
ref = db.reference("/server/saving-data/Other/2021-04-24/aoifeWalksC/")
...
# center longitude )
gmap = gmplot.GoogleMapPlotter(53.211785, -8.559224, 14) 
...
gmap.draw( "C:\\fyp_pc_work\\pictures\\map_garden.html" )
